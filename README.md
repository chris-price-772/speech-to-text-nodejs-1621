...
[![Deploy to Bluemix](https://bluemix.net/deploy/button.png)](https://bluemix.net/deploy?repository=https://github.com/chris-price-772/speech-to-text-nodejs-1621)
...
After completing the steps above, you are ready to test your service.
